...
export default function Header({ lang }: { lang: Language }) {
  return (
    <div className="fixed top-0 left-0 right-0 supports-backdrop-blur:bg-background/60 border-b bg-[#FAFAFA] dark:border-[#2a3b50] bg-background/95 backdrop-blur z-50 dark:bg-[#0a1c38]">
      <nav className="h-14 flex items-center justify-between px-4">
        <div className="hidden xl:flex">
          ...
          >
            ...
            />
            <h2 className="text-2xl font-bold tracking-tight">{lang=="en"?"TimeToGo": "وتشيز"}</h2>
          </Link>
        </div>
