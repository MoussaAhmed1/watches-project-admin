...
export default async function page({ searchParams,params }: paramsProps) {
  ...
  const breadcrumbItems = [{ title: navigation["admins"], link: `/dashboard/users/admins` }];
  return (
    <>
      <div className="flex-1 space-y-4  p-4 md:p-8 pt-6 ">
        ...
        <div className="flex items-start justify-between">
          <Heading
            title={`${navigation["admins"]} (${totalUsers})`}
          />
          <Link
            href={`/${params?.lang}/dashboard/users/admins/create-user`}
